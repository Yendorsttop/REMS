...
| ------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `deployment-revision.md` | reviewed commit SHA, immutable API/web/migration image digests, Blueprint revision, service names, and observed Oregon region (`oregon`) for all four resources |
| `migration-result.md`    | start/end UTC, migration image digest, exit result, Prisma migration names/checksums; no URL                                                                    |
